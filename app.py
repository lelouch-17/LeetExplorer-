...
def load_link_of_qs():
    with open("Leetcode-Questions-Scrapper-data/Qindex.txt", "r") as f:
        links = f.readlines()
...
def get_idf_value(term):
    return math.log((len(document))/(vocab[term]))
...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'sanjay-bisu'
...
class SearchForm(FlaskForm):
    search = StringField('Enter your query/tag:')
